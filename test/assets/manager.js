...
describe('asset.Manager', function () {
  ...
  beforeEach(function (done) {
    ...
    admanager = new ccwallet.assets.Manager(cdmanager, adstorage)
  ...
  describe('resolve', function () {
    it('resolve default bitcoin asset', function (done) {
      ...
      admanager.resolve(data)
        .then(function (adef) {
          expect(adef).to.be.instanceof(ccwallet.assets.Definition)
    ...
    it('all', function (done) {
      admanager.get()
        .then(function (adefs) {
          ...
          expect(adefs[0]).to.be.instanceof(ccwallet.assets.Definition)
