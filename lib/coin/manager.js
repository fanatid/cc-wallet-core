...
/**
 * @param {{txid: string, oidx: number}[]} coins
...
/**
 * @param {{txid: string, oidx: number}} coin
...
CoinManager.prototype.isCoinFrozen = function (coin) {
  var self = this
  return self._withLock(function () {
    return self._isCoinFrozen()
  })
}

/**
 * @param {{txid: string, oidx: number, value: number}} coin
 * @return {ColorValue}
 */
...
/**
 * @param {{txid: string, oidx: number, value: number}[]} coins
